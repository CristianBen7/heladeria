...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211014_cristiansgelatoben_f54ed8a65ff827af5276_20211020065512_archive.zip';
	const ARCHIVE_SIZE		 = '39088156';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f54ed8a-20065512';
    const SECONDARY_PACKAGE_HASH = 'e1d01d2-20065512';
	const VERSION			 = '1.4.3';
